...
const registerUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newUser = new user_model_1.User(Object.assign(Object.assign({}, data), { password: hashedPassword }));
        yield (0, mail_util_1.sendWelcomeEmail)(newUser.emailAddress, newUser.firstName);
