...
saleRouter.post("/createSale", auth_middleware_1.authMiddleware, multer_config_1.upload.array("itemImage"), (0, validateDto_middleware_1.validateDto)(sale_dto_1.CreateSaleDto), sale_controller_1.createSale);
